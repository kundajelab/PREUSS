...
# write.csv(dataset.filtered, file = "neil-editing_level-quantile.csv")

# WT Editing Level
wt_editing_value = 0.64
...
scatterplot.all_stem_length <- ggscatter(
    ...
    stat_cor(method = "pearson", 
             ...
             label.x = 20.005, label.y = 1.02) +  # Add correlation coefficient
...
```{r BoxPlot - all_stem_length-scatter, echo=FALSE, fig.width=6, fig.height=6}
...
scatterplot.u_all_stem_length <- ggscatter(
    ...
    stat_cor(method = "pearson", 
             aes(label = paste(..rr.label.., ..p.label.., sep = "~`,`~")), # Use R^2
             label.x = 2.005, label.y = 1.02) +  # Add correlation coefficient
