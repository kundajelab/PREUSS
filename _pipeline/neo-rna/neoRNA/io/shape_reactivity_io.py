...
"""
IO - ShapeMapper 2.x "Shape Reactivity"
================
"""
...
class ShapeReactivityIO(object):
    r"""
    IO to parse "Shape Reactivity" file generated by ShapeMapper 2.x.
    ...
    def parse_iterator(cls, handle):
        ...
        Usage
        -------
        >>> with open("rna_lib_item.shape") as handle:
        ...     for record in ShapeReactivityIO.parse_iterator(handle):
        ...         print(record)
        ...
        ...
        for data_list in cls.parse(handle):
            yield ShapeReactivityItem(data_list)
