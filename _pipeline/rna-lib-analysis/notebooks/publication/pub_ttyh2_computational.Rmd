...
params:
    ...
    dataset_codename_str: 'ttyh2_computational'
...
write.csv(dataset.filtered, file = "ttyh2-editing_level-quantile.csv")

# WT Editing Level
wt_editing_value = 0.306
...
scatterplot.all_stem_length <- ggscatter(
    ...
    stat_cor(method = "pearson", 
             ...
             label.x = 42.005, label.y = 1.02) +  # Add correlation coefficient
...
scatterplot.u_all_stem_length <- ggscatter(
    ...
    stat_cor(method = "pearson", 
             aes(label = paste(..rr.label.., ..p.label.., sep = "~`,`~")), # Use R^2
             label.x = 19.005, label.y = 1.02) +  # Add correlation coefficient
